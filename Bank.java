package lib;
	...
	final double limit = 10000,limit1 = 200;
		abstract void deposit(double n,Date d);
		abstract void withdraw(double n,Date d);
	}
						...
						if(bank.customerMap.containsKey(username))
						{
							...
							if(customer.password.equals(password))
							{
								while(true)
								{
									...
									System.out.println("------LOGN SUCCESFULLY-------------\n");
									System.out.println("1. Deposit.");
									System.out.println("2. Transfer.");
									System.out.println("3. Last 5 transactions.");
									System.out.println("4. Updated information.");
									...
									switch(choice)
									{
										...
										case 4:
										       ...
										       System.out.println("Accountholder contact : "+customer.balance);
										       break;
										case 5:
										       continue outer;
									        default:
